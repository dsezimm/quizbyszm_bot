...
11 commands: /start /help /quiz /topics /score /explain /about /feedback /hint /analyze /reset
Database: 40 Python + 40 SQL questions, grouped by topic
Quiz: 15 random questions each time
"""
...
# ═══════════════════════════════════════════════════════════════════════════════
#  QUESTIONS — 40 Python + 40 SQL, grouped by topic
# ═══════════════════════════════════════════════════════════════════════════════

QUESTIONS = {
    'python': [

        # ── TOPIC: Basic Syntax (8 questions) ─────────────────────────────────
        {
            "topic": "Basic Syntax",
        ...
        },
        {
            ...
            "answer": "B",
            "hint": "Square brackets with the key name 🗝️",
        ...
        },
        {
            ...
            "answer": "B",
            "hint": "Indexing starts at zero! 0️⃣",
        ...
        },
        {
            ...
            "answer": "B",
            "hint": "The end index is not included ✂️",
        ...
        },
        {
            ...
            "answer": "B",
            "hint": "Called when an object is created 🏗️",
        ...
        # ── TOPIC: Error Handling (4 questions) ───────────────────────────────
        {
        ...
        },
        {
            ...
            "answer": "B",
            "hint": "raise = throw an exception ⬆️",
    ...
    'sql': [
        ...
        # ── TOPIC: Aggregate Functions (6 questions) ───────────────────────────
        {
        ...
        # ── TOPIC: Data Modification (6 questions) ─────────────────────────────
        {
        ...
        },
        {
            ...
            "answer": "B",
            "hint": "No condition = deletes everything ⚠️",
        ...
        },
        {
            ...
            "answer": "B",
            "hint": "The main key — unique for every row 🗝️",
        ...
        # ── TOPIC: Transactions (3 questions) ─────────────────────────────────
        {
            "topic": "Transactions",
...
def make_topic_kb():
    ...
    kb.add(
        types.InlineKeyboardButton(f'🐍 Python ({py_count} questions)', callback_data='topic_python'),
        types.InlineKeyboardButton(f'🗄️ SQL ({sql_count} questions)', callback_data='topic_sql'),
    )
    return kb
...
def cmd_start(message):
    ...
    text = (
        ...
        "/about — about the bot\n"
        "/help — full guide\n\n"
        "🎲 The database has 40 Python + 40 SQL questions!\n"
        "Each time you play, *15 random questions* are picked.\n\n"
        "Let's go! 🚀 /quiz"
    )
...
# 6️⃣ /explain — full explanation of the last wrong answer
...
def cmd_about(message):
    ...
    text = (
        ...
        "  • Python 3.x\n\n"
        "👨‍💻 *Author:* dsezimm\n"
        "🎓 Final project for Python course, 2025\n"
...
def finish_quiz(chat_id, uid):
    ...
    # Keep session data for /analyze and /explain (questions cleared)
    sessions[uid] = {
        'topic': topic,
        'questions': [],
        'index': 0,
...
if __name__ == '__main__':
    ...
    print(f"📊 Python: {py_count} questions | SQL: {sql_count} questions")
    print(f"🎲 {QUESTIONS_PER_QUIZ} random questions per quiz")
    print(f"⌨️  11 commands active")
